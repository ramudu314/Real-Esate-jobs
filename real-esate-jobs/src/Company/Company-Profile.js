...
const CompanyProfile = () => {
  ...
  const [companyDetails, setCompanyDetails] = useState({
    name: 'My Elegate Group.',
    location: 'Block 2, My Home Hub',
    number: '123456789012',
    website: 'https://www.myelegantgroup.com/index.html',
    banner: '',
    logo: '',
  });
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      ...
      <p className="text-lg text-gray-600 mb-6">{companyDetails.location}</p>
