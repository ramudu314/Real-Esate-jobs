  ...
  return (
    <div>
      ...
      <nav className="flex justify-between items-center bg-white p-4 shadow-md">
        ...
        {showProfile && (
          <div className="absolute top-16 right-4 bg-white p-4 shadow-md w-64 md:w-80 z-10">
            <h2 className="text-lg font-bold mb-4">Welcome to Our Platform</h2>
            <p className="text-gray-700 text-sm mb-4">
              Login as a Real Estate Company or Applicant
            </p>
            <div className="flex flex-col space-y-4">
              ...
              <button
                className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
                onClick={navigateToApplicantProfile}
              >
                Applicant Profile
              </button>
            </div>
